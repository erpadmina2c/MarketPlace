            ...
            var s_ids = string.Join(",", request.options);
                ...
                foreach (var req in request.options)
                    ...
                    {   
                            ...
                            // Body 
                            builder.HtmlBody = @"<!DOCTYPE html><html><head><title>Circular Computing</title></head><body><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr> <td align='center' valign='top' bgcolor='#80808057' style='background-color:#fff;'> <br><br><table width='600' border='1' cellspacing='0' cellpadding='0'><tr><td align='left' valign='top' bgcolor='#564319' style='background-color:#062736 ; font-family:Arial, Helvetica, sans-serif; padding:10px;'><div style='font-size:13px; color:#08ab9e;text-align: center;font-family: sans-serif;'> <b>ITAD Deal Alert</b></div></td></tr><tr><td align='left' valign='top' bgcolor='#ffffff' style='background-color:#ffffff;'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='center' valign='middle' style='padding:10px; color:#21355C ; font-size:28px; font-family:Georgia, 'Times New Roman', Times, serif;'><small></small> </td></tr></table><table width='95%' border='0' align='center' cellpadding='0' cellspacing='0'> <tr><td align='left' valign='middle' style='color:#062736; font-family:Arial, Helvetica, sans-serif; padding:10px;'> <div style='font-size:12px;'> Dear <span style='text-transform:capitalize'>"+ user.username+"</span></div><div style='font-size:12px;'>New ITAD deal available for your consideration. Please check attached file for further detail.</div></td></tr></table><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='left' valign='middle' style='padding:15px; background-color:#062736 ; font-family:Arial, Helvetica, sans-serif;'><div style='font-size:13px; color:#fff;'> <br><span href='http://itad.circularcomputing.com' style='color:#08ab9e; text-decoration:underline;'>Please do not reply to this email.</span><br/></div></td></tr></table></td></tr></table> <br><br></td></tr></table></body></html>";
