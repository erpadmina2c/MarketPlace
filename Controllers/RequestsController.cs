            ...
            if(request.s_flag) {
                ...
                foreach (var req in request.options)
                    {     
                        ...
                        // Body 
                        message.Body =  new TextPart("html"){
                            Text = "<!DOCTYPE html><html><head><title>A2C Services LLC</title></head><body><html><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/><title>A2C Services LLC</title></head><body><div style='padding:22px;font-weight: bold;font-family: monospace;font-size: 15px;'> " + result1.s_qty + " x " + result1.MakeName + " " + result1.ModelName + " " + result1.Processor + " " + result1.Processor + "/"  + result1.RAMName+ " / " + result1.HddName + " @ " + result1.s_currency+""+ result1.s_price+ "</div><div style='padding:22px;font-style: italic;font-family: sans-serif;font-size: 15px;'>On Behalf Of:</div><div style='padding:22px;font-weight: bold;font-family: sans-serif;font-size: 15px;'>A2C Services L.L.C</div></body></html></body></html>",
                        };
