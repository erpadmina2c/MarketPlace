        ...
        public async Task<IActionResult> EditreqDataPost([FromBody]History request)
        {
           ...
           List<RequirementList> availableStock = new List<RequirementList>();
            ...
            foreach (var item in users)
            {
                    ...
                    // Body 
                    message.Body =  new TextPart("html"){
                        Text = "<!DOCTYPE html><html><head><title>Circular Computing</title></head><body><html><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/> <title>Circular Computing</title></head><body> <table width='100%' border='0' cellspacing='0' cellpadding='0'><tr> <td align='center' valign='top' bgcolor='#80808057' style='background-color:#80808057;'> <br><br><table width='600' border='0' cellspacing='0' cellpadding='0'> <tr><td height='70' align='left' valign='middle'></td></tr><tr><td align='left' valign='top' bgcolor='#564319' style='background-color:#062736 ; font-family:Arial, Helvetica, sans-serif; padding:10px;'><div style='font-size:13px; color:#08ab9e;text-align: center;font-family: sans-serif;'> <b>Stock Modify Alert</b></div></td></tr><tr><td align='left' valign='top' bgcolor='#ffffff' style='background-color:#ffffff;'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='center' valign='middle' style='padding:10px; color:#062736 ; font-size:28px; font-family:Georgia, 'Times New Roman', Times, serif;'><small>Stock #"+result1.RequestID+".</small> </td></tr></table><table width='95%' border='0' align='center' cellpadding='0' cellspacing='0'> <tr><td align='left' valign='middle' style='color:#062736; font-family:Arial, Helvetica, sans-serif; padding:10px;'> <div style='font-size:16px;'> Dear <span style='text-transform:capitalize'>" + item.username + "</span>, </div><div style='font-size:12px;'> Stock #"+result1.RequestID+"  has been Modified by "+result1.Username+" <hr></div></td></tr></table><table width='100%' border='0' cellspacing='0' cellpadding='0' style='border-bottom:2px solid #847b7b91'><tr><td align='center' valign='middle' style='padding:5px;'></td></tr></table><div style='font-size:20px;color:#08ab9e;background: #062736 ;font-family:Arial, Helvetica, sans-serif;text-align: center;padding: 19px 1px;'><b>Stock Specification.</b></div><table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' style='margin: 18px 51px;margin-bottom:15px;font-family:Arial, Helvetica, sans-serif;'> <tr> <th style='font-size:16px; color:#062736;text-align: left;width: 20%;'>Make:</th> <td style='font-size:16px; color:#062736;text-align: left;'>" + result1.MakeName + "</td><th style='font-size:16px; color:#062736;text-align: left;width: 20%;'>HDD:</th> <td style='font-size:16px; color:#062736;text-align: left;'>" + result1.HddName + "</td></tr><tr> <th style='font-size:16px; color:#062736;text-align: left;width: 20%;'>Model:</th> <td style='font-size:16px; color:#062736;text-align: left;'>" + result1.ModelName + "</td><th style='font-size:16px; color:#062736;text-align: left;width: 20%;'>RAM:</th> <td style='font-size:16px; color:#062736;text-align: left;'>" + result1.RAMName + "</td></tr><tr> <th style='font-size:16px; color:#062736;text-align: left;width: 20%;'>Processor:</th> <td style='font-size:16px; color:#062736;text-align: left;'>" + result1.Processor + "</td><th style='font-size:16px; color:#062736;text-align: left;width: 20%;'>Adapter:</th> <td style='font-size:16px; color:#062736;text-align: left;'>"+result1.AdapterName+"</td></tr><tr> <th style='font-size:16px; color:#062736;text-align: left;width: 20%;'>Qty:</th> <td style='font-size:16px; color:#062736;text-align: left;'>" + result1.Qty + "</td><th style='font-size:16px; color:#21355C;text-align: left;width: 20%;'>Price:</th> <td style='font-size:16px; color:#21355C;text-align: left;'>" + result1.Price + "</td></tr></table> <table width='100%' border='0' cellspacing='0' cellpadding='0'> <tr> <td align='left' valign='middle' style='padding:15px; background-color:#062736 ; font-family:Arial, Helvetica, sans-serif;'> <div style='font-size:13px; color:#08ab9e;'> <br><a href='http://a2cshops.com' style='color:#08ab9e; text-decoration:underline;'>CLICK HERE</a> TO CHECK STOCK </div></td></tr></table></td></tr></table> <br><br></td></tr></table> </body> </html> </body></html>",
                    };
            ...
            var s_ids = string.Join(",", request.options);
                ...
                foreach (var req in request.options)
                    ...
                    {   
                            ...
                            // Body 
                            builder.HtmlBody = @"<!DOCTYPE html><html><head><title>Circular Computing</title></head><body><html><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/> <title>Circular Computing</title></head><body> <table width='100%' border='0' cellspacing='0' cellpadding='0'><tr> <td align='center' valign='top' bgcolor='#80808057' style='background-color:#80808057;'> <br><br><table width='600' border='0' cellspacing='0' cellpadding='0'> <tr><td height='70' align='left' valign='middle'></td></tr><tr><td align='left' valign='top' bgcolor='#564319' style='background-color:#062736 ; font-family:Arial, Helvetica, sans-serif; padding:10px;'><div style='font-size:13px; color:#08ab9e;text-align: center;font-family: sans-serif;'> <b>ITAD Deal Alert</b></div></td></tr><tr><td align='left' valign='top' bgcolor='#ffffff' style='background-color:#ffffff;'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='center' valign='middle' style='padding:10px; color:#21355C ; font-size:28px; font-family:Georgia, 'Times New Roman', Times, serif;'><small></small> </td></tr></table><table width='95%' border='0' align='center' cellpadding='0' cellspacing='0'> <tr><td align='left' valign='middle' style='color:#062736; font-family:Arial, Helvetica, sans-serif; padding:10px;'> <div style='font-size:16px;'> Dear <span style='text-transform:capitalize'>"+ user.username+"</span></div><div style='font-size:12px;'>New ITAD deal available for your consideration. Please check attached file for further detail.</div></td></tr></table><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='left' valign='middle' style='padding:15px; background-color:#062736 ; font-family:Arial, Helvetica, sans-serif;'><div style='font-size:13px; color:#fff;'> <br><span href='http://a2cshops.com' style='color:#08ab9e; text-decoration:underline;'>Please do not reply to this email.</span><br/></div></td></tr></table></td></tr></table> <br><br></td></tr></table> </body> </html> </body></html>";
