...
/* harmony import */ var _loadspecs_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./loadspecs.service */ "./src/app/_services/loadspecs.service.ts");
...
var AuthService = /** @class */ (function () {
    function AuthService(http, alertify, loadspecsService, router) {
        this.http = http;
        this.alertify = alertify;
    ...
    AuthService.prototype.checkAcess = function () {
        var _this = this;
        return this.loadspecsService.getmenus(Number(localStorage.getItem('RoleID'))).subscribe(function (menus) {
            _this.menus = menus.filter(function (proj) { return (proj.url === _this.router.url); });
            if (_this.menus.length !== 1 && _this.router.url !== '/dashboard' && _this.router.url !== '/profile') {
                _this.alertify.error('Access Denied');
    ...
    AuthService.ctorParameters = function () { return [
        ...
        { type: _loadspecs_service__WEBPACK_IMPORTED_MODULE_7__["LoadspecsService"] },
    ...
    AuthService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _alertify_service__WEBPACK_IMPORTED_MODULE_6__["AlertifyService"], _loadspecs_service__WEBPACK_IMPORTED_MODULE_7__["LoadspecsService"],
...
var LoadspecsService = /** @class */ (function () {
    ...
    LoadspecsService.prototype.getSupUsers = function () {
        return this.http.get(this.baseUrl + 'getsupusers');
    };
    ...
    LoadspecsService.prototype.RejectCompany = function (request) {
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'chat-setting',
                loadChildren: function () { return __webpack_require__.e(/*! import() | views-chat-setting-chat-setting-module */ "views-chat-setting-chat-setting-module").then(__webpack_require__.bind(null, /*! ./views/chat-setting/chat-setting.module */ "./src/app/views/chat-setting/chat-setting.module.ts")).then(function (m) { return m.ChatSettingModule; }); },
            },
            {
                path: 'stocks',
            ...
            },
            {
                ...
                loadChildren: function () { return __webpack_require__.e(/*! import() | views-itad-chat-setting-itad-chat-setting-module */ "views-itad-chat-setting-itad-chat-setting-module").then(__webpack_require__.bind(null, /*! ./views/itad-chat-setting/itad-chat-setting.module */ "./src/app/views/itad-chat-setting/itad-chat-setting.module.ts")).then(function (m) { return m.ItadChatSettingModule; }); }
            },
            {
                path: 'approvedstock',
            ...
            {
                path: 'shareddeals',
                loadChildren: function () { return Promise.all(/*! import() | views-share-deals-share-deals-module */[__webpack_require__.e("default~views-add-price-add-price-module~views-approved-stocks-approved-stocks-module~views-check-pr~41bd992d"), __webpack_require__.e("views-share-deals-share-deals-module")]).then(__webpack_require__.bind(null, /*! ./views/share-deals/share-deals.module */ "./src/app/views/share-deals/share-deals.module.ts")).then(function (m) { return m.ShareDealsModule; }); }
            },
            {
                path: 'salesteam',
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("p {\r\n    margin-bottom: 1.6em;\r\n    font-size: 19px;\r\n}\r\n.btn {\r\n    background-color: rgb(4, 170, 157) !important;\r\n    color : #ffffff;\r\n    font-weight: bold;\r\n    border-radius: 0px;\r\n    border: rgb(4, 170, 157);\r\n}\r\n.btnalign {\r\n    float: right;\r\n    font-size: 13px;\r\n    padding: 5px;\r\n}\r\ninput {\r\n    height: 51px;\r\n    width: 100%;\r\n}\r\n.card-group{\r\n    opacity: .9;\r\n}\r\n.bgimage{\r\n    width:38%;float:left;margin: 30px 0px;\r\n    margin: 10px 0px!important;\r\n}\r\na {\r\n    text-decoration: underline!important;\r\n    font-weight: bold!important;\r\n}\r\ninput::-webkit-outer-spin-button,\r\ninput::-webkit-inner-spin-button {\r\n  -webkit-appearance: none;\r\n  margin: 0;\r\n}\r\n/* Firefox */\r\ninput[type=number] {\r\n  -moz-appearance: textfield;\r\n}\r\n@media (max-width: 991.98px) {\r\n    .card {\r\n        width: 100%!important;\r\n        padding: 0px!important;\r\n        flex: none!important;\r\n    }\r\n    .card-body {\r\n        padding: 10px!important;\r\n    }\r\n    .bgimage{\r\n        width:71%!important;\r\n        float:left;\r\n        margin: 5px 0px!important;\r\n\r\n    }\r\n    .banner-head {\r\n        font-size: 133%;\r\n    }\r\n     \r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.VerifyOTP = function () {
        ...
        this.authService.verifyotp(this.otpmodel).subscribe(function (users) {
            _this.otpflag = false;
    ...
    LoginComponent.prototype.omit_special_char = function (event) {
        var k;
    ...
    LoginComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./login.component.css */ "./src/app/views/login/login.component.css")).default]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".text-muted{\r\n    color: #062736!important;\r\n}\r\ninput::-webkit-outer-spin-button,\r\ninput::-webkit-inner-spin-button {\r\n  -webkit-appearance: none;\r\n  margin: 0;\r\n}\r\n/* Firefox */\r\ninput[type=number] {\r\n  -moz-appearance: textfield;\r\n}\r\n.card {\r\n    opacity: .9;\r\n}\r\n.card-body {\r\n  border: 1px solid #00343e;\r\n  padding: 0px;\r\n}\r\nsmall {\r\n  font-weight: bold;\r\n  color: #00343e;\r\n}\r\nselect {\r\n  width: 8%!important; \r\n}\r\nform {\r\n  margin: 1rem;;\r\n}\r\nh3 {\r\n  text-align: center;\r\n  border-bottom: 1px solid #00343e;\r\n  padding: 9px 0px;\r\n}\r\np {\r\n  margin: 1rem;;\r\n}\r\n@media (max-width: 991.98px) {\r\n  .card {\r\n      width: 100%!important;\r\n      padding: 0px!important;\r\n      margin: 0px!important;\r\n  }\r\n  .card-body {\r\n      padding: 10px!important;\r\n  }\r\n  .bgimage{\r\n      width:71%!important;\r\n      float:left;\r\n      margin: 5px 0px!important;\r\n\r\n  }\r\n  .banner-head {\r\n      font-size: 10%;\r\n      font-size: 109%;\r\n  }\r\n  select{\r\n      width: 83%!important; \r\n  }\r\n  .btn {\r\n    width: 89%;\r\n    margin: auto;\r\n  }   \r\n}\r\n@media (min-width: 1200px){\r\n  .container {\r\n      max-width: 1350px;\r\n  }\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(loadspecsService, userService, alertify, authService) {
        this.loadspecsService = loadspecsService;
        ...
        this.mymodel = {};
        this.registercheck = 0;
        this.emailexist = ['gmail', 'googlemail', 'protonmail', 'protonmail', 'outlook', 'hotmail', 'yahoo', 'zoho', 'aim', 'aol', 'gmx', 'gmx', 'icloud', 'yandex'];
    }
    RegisterComponent.prototype.ngOnInit = function () {
        this.mymodel.Country = '0';
        this.loadLocations();
    };
    RegisterComponent.prototype.loadLocations = function () {
        var _this = this;
        return this.loadspecsService.loadLocations().subscribe(function (locations) {
            _this.locations = locations.filter(function (proj) { return (proj.status === 1); });
        }, function (error) {
    ...
    RegisterComponent.prototype.Reqister = function () {
        var _this = this;
        ...
        var splitted1 = splitted[1].split('.', 3);
    ...
    RegisterComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./register.component.css */ "./src/app/views/register/register.component.css")).default]
        }),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_loadspecs_service__WEBPACK_IMPORTED_MODULE_4__["LoadspecsService"], _services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"],
