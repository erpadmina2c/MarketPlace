...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\nbutton {\r\n    background-color: #08ab9e;\r\n    color: #fff;\r\n}\r\n.close {\r\n    background: transparent!important;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
var ItdaRequirementsComponent = /** @class */ (function () {
    ...
    ItdaRequirementsComponent.prototype.sendPurchaseOrderPost = function () {
        ...
        if (this.model.ptype_id === '1' && this.model.lang_id === undefined) {
            this.alertify.error('Select KB Language');
            return;
        }
        if (this.model.ptype_id === '1' && this.model.lang_id === undefined) {
            this.alertify.error('Select KB Language');
        ...
        if (this.model.po_price < 0) {
            this.alertify.error('Invalid Price');
            return;
        }
        if (!this.model.p_eta) {
        ...
        if (this.model.ptype_id === '1') {
            ...
            this.itadmodel.model_id = this.model.model_id;
            this.itadmodel.cpu_id = this.model.cpu_id;
            this.itadmodel.lang_id = this.model.lang_id;
        ...
        this.requirementservice.sendITADPost(this.itadmodel).subscribe(function (itadlist) {
            ...
            _this.alertify.success('ITAD Submitted Successfully');
            _this.loadITAD();
        }, function (error) {
            _this.alertify.error(error);
        });
