...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\nbutton {\r\n    background-color: #08ab9e;\r\n    color: #fff;\r\n    border: 0;\r\n}\r\n.close {\r\n    background: transparent!important;\r\n}\r\n.addstockmodal {\r\n    max-width: 47%;\r\n}\r\n.table-responsive-sm {    \r\n    overflow-x: scroll;\r\n}\r\n@media (max-width: 1109px) {\r\n    .addstockmodal {\r\n        max-width: 69%;\r\n    }\r\n}\r\n@media (max-width: 579px) {\r\n    .addstockmodal {\r\n        max-width: 90%;\r\n    }\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
var ItdaRequirementsComponent = /** @class */ (function () {
    ...
    ItdaRequirementsComponent.prototype.OpenEmaiModal = function (id, user_id, p_title) {
        console.log('first');
        var email = 'mailto:suhel.cs@gmail.com';
        window.location.href = email;
        console.log('last');
        // return this.userService.getUsers().subscribe((users: User[]) => {
        //   this.users = users.filter(proj => (proj.id === user_id));
        //   this.companydetail.email = this.users[0].email;
        //   this.companydetail.subject = 'RE: ' + p_title;
        //   this.companydetail.username = this.users[0].username;
        //   this.companydetail.text = '';
        //   this.emailsendModel.show();
        // }, error => {
    ...
    ItdaRequirementsComponent.prototype.omit_special_char = function (event) {
        var k;
        k = event.charCode; //         k = event.keyCode;  (Both can be used)
        return (k === 8 || (k >= 48 && k <= 57));
    };
    ItdaRequirementsComponent.prototype.omit_decimal_char = function (event) {
        var k;
        k = event.charCode; //         k = event.keyCode;  (Both can be used)
